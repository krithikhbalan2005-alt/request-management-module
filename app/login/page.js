...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      console.log("SUCCESS");
      // Use standard router push or location assign
      router.push("/dashboard");
    } catch (err) {
      console.error("Login error:", err);
      // Clean up firebase errors to be user friendly
    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-md glass-panel p-8 rounded-2xl animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-2">Sign in to manage your public requests</p>
        </div>
